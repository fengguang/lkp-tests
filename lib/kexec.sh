...
download_initrd()
{
	...
	for _initrd in $(echo $initrd $tbox_initrd $job_initrd $lkp_initrd $bm_initrd $modules_initrd $linux_headers_initrd $linux_selftests_initrd $linux_perf_initrd | tr , ' ')
	do
